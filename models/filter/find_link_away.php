...
class find_link_away extends Afilter
{
	static function static_filter($message)
	{
		...
		$result = preg_replace_callback(
			'/("(http[s]{0,1}:\/\/([a-zA-Zà-ÿÀ-ß¸¨0-9]+[\w0-9\x5C\x2F\x27\x28\x29\x20\x60\$\-\_\.\+\!\*\,\{\}\|\^\~\[\]\;\?\:\@\&\=\<\>\#\%]+)*)")|(\x27(http[s]{0,1}:\/\/([a-zA-Zà-ÿÀ-ß¸¨0-9]+["\w0-9\x5C\x2F\x28\x29\x60\x20\$\-\_\.\+\!\*\,\{\}\|\^\~\[\]\;\?\:\@\&\=\<\>\#\%]+)*)\x27)|((http[s]{0,1}:\/\/([a-zA-Zà-ÿÀ-ß¸¨0-9]+["\w0-9\x5C\x2F\x27\x28\x29\x60\$\-\_\.\+\!\*\,\{\}\|\^\~\[\]\;\?\:\@\&\=\<\>\#\%]+)*))/'
			, $edit_link, $message);
		return $result;
	}
